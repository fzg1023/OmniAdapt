...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='omniadapt', choices=['omniadapt'],
                        help='training script name')
    parser.add_argument('--config', type=str, default='omniadapt', help='yaml configure file name')
...
if __name__ == "__main__":
    ...
    if args.script == "omniadapt":
        model_module = importlib.import_module('lib.models')
        model_constructor = model_module.build_omniadapt
