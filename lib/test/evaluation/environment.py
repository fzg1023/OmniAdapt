...
class EnvSettings:
    def __init__(self):
        ...
        lasher_root = os.environ.get('LASHER_ROOT', os.path.join(os.environ.get('DATA_ROOT', ''), 'lasher'))
        self.lasher_path = lasher_root
        self.lashertestingset_path = os.path.join(lasher_root, 'testingset')
